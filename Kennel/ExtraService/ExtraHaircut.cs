...
{
    public class ExtraHaircut : IExtraHaircut
    {
        public string Name => "Hair cut";
        ...
        public ExtraHaircut(IDbLists db)
        {
            TrueOrFalse = false;
            Db = db;
        }
        ...
        public void AddExtraService()
        {
            ...
            Console.WriteLine("Choose the animal you want to get hair done:");
            int intAnimal = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine($"You added haircut to {Db.AnimalList[intAnimal].Name} for {Price} USD");
